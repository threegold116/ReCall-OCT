...
class RLHFDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.prompt_template = prompt_template_dict[prompt_template_name] if prompt_template_name else None
    ...
    def __getitem__(self, item):
        ...
        # TODO(cmy): handling when chat is not a list but a string when not apply_chat
