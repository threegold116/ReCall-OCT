...
def iterretgen(args):
    ...
    # preparation
    config = Config("/mnt/bc_fs/code/sft/cmy/code/FlashRAG/examples/methods/my_config.yaml", config_dict)
    all_split = get_dataset(config)
    test_data = all_split[args.split]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", type=str, default="evaluation/eval_config.yaml")
