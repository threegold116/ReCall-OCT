...
def parse_args():
    ...
    #THREEGOLDCHANGE
    merge_parser.add_argument(
        "--hf_model_config_path",  default=None, type=str, help="Hugging Face repository ID to upload the model"
    )
    #THREEGOLDCHANGE
...
def generate_config_from_args(args: argparse.Namespace) -> ModelMergerConfig:
    common_config_args = {
        ...
        "hf_model_config_path": os.path.join(args.local_dir, "huggingface") if args.hf_model_config_path is None else args.hf_model_config_path,
